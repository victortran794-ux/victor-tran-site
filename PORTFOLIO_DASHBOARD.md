...
| IBM Patterns | bounded copy/hierarchy lane production-verified in PR #119 | public, indexable, included in sitemap | Current route-opening branch plus `Website Items\Portfolio Packages\IBM Patterns\` | Replace homepage thumbnail if Victor supplies one | Preserve six-week, five-person, non-shipped, influence, experimental, and collaboration boundaries |
