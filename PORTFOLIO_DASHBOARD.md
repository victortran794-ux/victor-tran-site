...
| IBM Cloud | bounded hiring narrative production-verified in PR #119 | public, indexable, included in sitemap | Current route-opening branch plus `Website Items\Portfolio Packages\IBM Cloud\` | Replace two honest evidence reservations only when Victor supplies cleared supporting images | Preserve employer/customer distinction, attribution, provenance, conservative experimental framing, and claims boundaries |
| IBM Patterns | bounded copy/hierarchy lane production-verified in PR #119 | public, indexable, included in sitemap | Current production baseline plus `Website Items\Portfolio Packages\IBM Patterns\` | Thumbnail replacement staged on `feat/ibm-patterns-presentation-cover-thumbnail-2026-08-10`; pending Victor approval, merge, and production verification | Preserve six-week, five-person, non-shipped, influence, experimental, and collaboration boundaries |
